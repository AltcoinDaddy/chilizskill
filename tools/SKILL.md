...
Configure the compiler target carefully. The docs contradict themselves: the Write a Smart Contract page says Solidity 0.8.30 or lower with EVM target `prague`, while the Developers FAQ still says 0.8.24 with Shanghai. Prefer the former, verify on Spicy.
