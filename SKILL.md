...
3. **The official docs disagree with themselves on compiler version.** The Write a Smart Contract page says Solidity **0.8.30 or lower, target EVM `prague`**. The Developers FAQ still says **0.8.24, Shanghai**. The FAQ is the stale one. Verify against the live chain before trusting either.
